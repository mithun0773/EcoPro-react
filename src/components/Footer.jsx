      ...
      <div style={styles.glassContainer}>
        <div style={styles.content}>
          ...
          <div style={styles.brandSection}>
            ...
            <p style={styles.subtitle}>AI-Powered Economic Intelligence</p>
            <div style={styles.stats}>
              ...
              <div style={styles.statItem}>
                ...
                <div style={styles.statLabel}>Years Coverage</div>
              </div>
              <div style={styles.statItem}>
                <div style={styles.statNumber}>AI</div>
                <div style={styles.statLabel}>Forecasting</div>
              </div>
            </div>
          </div>
          ...
          <div style={styles.linksGrid}>
            <div style={styles.linkCol}>
              ...
              <a href="/gdp" style={styles.footerLink}>
                GDP Analytics
              </a>
              <a href="/inflation" style={styles.footerLink}>
                Inflation Tracker
              </a>
              <a href="/population" style={styles.footerLink}>
                Demographics
              </a>
              <a href="/health" style={styles.footerLink}>
                Health Insights
              </a>
            </div>
            ...
            <div style={styles.linkCol}>
              ...
              <div style={styles.socialIcons}>
                <a href="#" style={styles.iconButton}>
                  <Github size={18} />
                </a>
                <a href="#" style={styles.iconButton}>
                  <Linkedin size={18} />
              ...
              <a href="mailto:hello@ecopro.ai" style={styles.email}>
                hello@ecopro.ai
              </a>
            </div>
          </div>
